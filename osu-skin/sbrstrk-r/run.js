const rafisskin = {
    ...
    image: './image/skin-Rafis2018HDDT.jpg',
};
const bluebudgieskinmixv1_1 = {
    name: 'BlueBudgie Skin Mix v1.1',
    url: 'https://drive.google.com/file/d/1OmKr9YPWc-o48-v0UwN2a0cok8Kkd8bk/view',
    image: './image/skin-bluebudgiemix1dot1.jpg',
}
...
const skins = [
    {
        ...
        skins: [
            bluebudgieskinmixv1_1,
            {
                ...
                image: './image/skin-seungwonselaina.jpg',
            },
            {
                name: 'SaberStrike 1.5',
                url: 'https://drive.google.com/file/d/1OmKr9YPWc-o48-v0UwN2a0cok8Kkd8bk/view',
                image: './image/skin-SaberStrike1dot5.jpg',
            },
            {
                name: 'SaberStrike 1.2/1.3 (they look the same)',
                url: 'https://www.mediafire.com/file/ouzknrd07gstnrd/',
                image: './image/skin-SaberStrike1dot2.jpg',
            },
            rafisskin,
        ]
    },
        ...
        skins: [
            {
                ...
                image: './image/skin-saberstrikedt1dot3.jpg',
            },
        ]
    },
    {
        ...
        skins: [
            {
                ...
                image: './image/skin-byonick1dot1.jpg',
            },
        ]
    },
    {
        ...
        skins: [
            {
                ...
                image: './image/skin-saberstrike0oniisan.jpg',
            },
        ]
    },
    {
        ...
        skins: [
            {
                name: '- # Spazza17 v2 [Fumo Bacon]',
                url: 'https://drive.google.com/file/d/1UFAdS-EbO4GiPQgZS95fcA3fQfq6WYE9/view',
                image: './image/skin-spazzafumobacon.jpg',
            },
            {
                name: 'Rafis HDDT mrekk',
                url: 'https://github.com/DevenRam/mrekk-osu-Skins#rafis-hddt',
                image: './image/skin-rafishddtmrekk.jpg',
            },
        ]
    },
    {
...
function generate(name) {
    activateNav('linkSbrstrk-rSkins', true);
    const main = document.getElementById('main');
    const user = skins.find(x => x.name == name);
    if (user) {
        ...
        h2.innerText = 'Could not find skin labelled: ' + name;
        main.append(h2)
    }
}